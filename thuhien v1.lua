...
spawn(function() 
    ...
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Thì thuhien v1 Hub đã trở lại!!!!!<Color=/>"):Display()
    wait(.14)
...
local Window = OrionLib:MakeWindow({Name = "thuhien v1 Hub", HidePremium = false, IntroText = "thuhien v1Hub Library", SaveConfig = true, ConfigFolder = "thuhien v1 Hub"})
...
OrionLib:MakeNotification({
	Name = "thuhien v1 Hub",
	Content = "thuhien v1 Hub Not Skidder, Please don't says",
	Image = "rbxassetid://4483345998",
	Time = 25
})
...
W:AddLabel("[+] thuhien v1 Hub is back!")
...
M:AddToggle({
    Name = "Auto Farm trái cây Mastery",
    Default = false,
    Flag = "Mastery",
    Save = true,
    Callback = function(Value)
...
IQ:AddToggle({
    ...
    Callback = function(Value)
        ...
        IQ:AddLabel("Cho ai không hiểu thì đây là tự động đánh hình nộm")
...
ToggleHallow = IQ:AddToggle({
            Name = "Auto lưỡi hái bóng tối[HOP]",
            Default = false,
        ...
        IQ:AddToggle({
            Name = "Auto dao gâm bóng tối[HOP]",
            Default = false,
            Flag = "Auto Dark[HOP]",
            Save = true,
            Callback = function(Value)
...
IQ:AddToggle({
    Name = "Auto tự động and tìm đảo bí ẩn",
    Default = false,
    Flag = "Auto Mirrage",
    Save = true,
    Callback = function(Value)
...
D:AddToggle({
    Name = "Auto vứt trái (chỉ vứt đc chx lưu trữ)",
    Default = false,
...
R:AddToggle({
    Name = "Auto Turn On tộc v3",
    Default = false,
    Flag = "Auto Turn On tộc v3",
    Save = true,
    Callback = function(Value)
        _G.V3 = Value
    end    
...
R:AddToggle({
    Name = "Auto Turn On tộc v4",
    Default = false,
    Flag = "Auto Turn On tộc v4",
    Save = true,
    Callback = function(Value)
        _G.V4 = Value
    end    
...
MoveCamTooMoonToggle = R:AddToggle({
    Name = "cam nhìn lên mặt trăng",
    Default = false,
    Flag = "cam nhìn lên mặt trăng",
    Save = true,
    Callback = function(Value)
        _G.AutoDooHee = Value
    end    
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "thuhie v1 Hub(Noitification)",
                    Content = "[EN] : Please cancel the farrm level quest (if any)",
                    Image = "rbxassetid://4483345998",
                    Time = 9
                })
                OrionLib:MakeNotification({
                    Name = "thuhien v1 Hub(Noitification)",
